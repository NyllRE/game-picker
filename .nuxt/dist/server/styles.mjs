...
export default {
  "pages/tabs/tab4.vue": () => import('./_nuxt/tab4-styles.97ec005a.mjs').then(interopDefault),
  "components/ExploreContainer.vue": () => import('./_nuxt/ExploreContainer-styles.6d9a440b.mjs').then(interopDefault),
